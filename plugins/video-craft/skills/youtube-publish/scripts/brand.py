...
# The paper-explainer skill ships the fonts the films are lettered in. Reusing
# them is what makes the channel art look like the videos rather than like a
# generic template. Falling back keeps this skill usable on its own.
_HERE = os.path.dirname(os.path.abspath(__file__))
_FONTS = os.path.normpath(
    os.path.join(_HERE, "..", "..", "paper-explainer", "fonts"))
