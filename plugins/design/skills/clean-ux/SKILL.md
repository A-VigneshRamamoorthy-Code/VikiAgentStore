...
description: >
  ...
  design looks like — you choose how to implement the styles. Use when building
  landing pages, web apps, dashboards, or any UI that should follow this design
  system (tokens, typography, buttons, cards, accordions, sidebars, modals, etc.).
license: MIT
metadata:
